...
public class ShowStats : MonoBehaviour {
    ...
    void Update () {
        guiText.text =
            ...
            "Current X Position: " + Utilities.Round(projectileMotion.ball.
                                                     transform.localPosition.x) + " meters\n" +
            "Current Y Position: " + Utilities.Round(projectileMotion.ball.
                                                     transform.localPosition.y) + " meters\n" +
            "Current Velocity: " +  Utilities.Round(projectileMotion.velocity) +
                                                                        " meters / seconds\n" +
            "Current Horizontal Velocity: " + Utilities.Round(projectileMotion.horizontalVelocity) +
                                                                             " meters / seconds\n" +
            "Current Vertical Velocity: " + Utilities.Round(projectileMotion.verticalVelocity) +
                                                                            " meteres / seconds\n" +
